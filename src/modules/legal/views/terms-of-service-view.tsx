              ...
              <div className="prose prose-base prose-slate max-w-none">
                ...
                <section id="1-introduction" className="mb-10">
                  ...
                  <p className="text-gray-700 text-base leading-relaxed mb-4">
                    ...
                    &quot;us,&quot; &quot;our,&quot; or the
                    &quot;Service&quot;), an AI-powered platform that provides
                    text-to-image, image-to-image, and text-to-video generation
                    services. These Terms of Service (&quot;Terms&quot;) govern
                ...
                <section id="2-acceptance-of-terms" className="mb-10">
                  ...
                  <p className="text-gray-700 text-base leading-relaxed mb-4">
                    You must be at least 13 years old to use our Service. By
                ...
                <section id="3-service-description" className="mb-10">
                  ...
                  <p className="text-gray-700 text-base leading-relaxed mb-4">
                    {siteConfig.name} provides AI-powered content generation
                    services, including:
                  </p>
                  <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 text-base leading-relaxed">
                    <li>
                      <strong>Text-to-Image Generation:</strong> Create images
                      from text descriptions
                    </li>
                    <li>
                      <strong>Image-to-Image Generation:</strong> Transform
                      existing images using AI
                    </li>
                    <li>
                      <strong>Text-to-Video Generation:</strong> Generate videos
                      from text prompts
                    </li>
                    <li>
                      <strong>Content Management:</strong> Store, organize, and
                  ...
                  <div className="mb-4">
                    ...
                    <ul className="list-disc list-inside space-y-1.5 text-gray-700 text-sm ml-4">
                      ...
                      <li>
                        Credit-based system with fixed monthly credit allocation
                      </li>
                      <li>
                        Each generation consumes credits based on complexity and
                        type
                      </li>
                ...
                <section id="4-user-accounts" className="mb-10">
                  ...
                  <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 text-base leading-relaxed">
                    <li>
                      You can create an account by signing in with your Google
                      account
                    </li>
                    <li>
                ...
                <section
                  id="5-subscription-plans-and-payment"
                  className="mb-10"
                >
                  <h2 className="text-xl font-bold text-gray-900 mb-5">
                  ...
                  <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 text-base leading-relaxed">
                    ...
                    <li>
                      Payment is processed through third-party providers
                      (Stripe, PayPal, Creem)
                    </li>
                    <li>
                  ...
                  <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 text-base leading-relaxed">
                    ...
                    <li>
                      Different content types may consume different credit
                      amounts
                    </li>
                    <li>
                ...
                <section id="6-acceptable-use-policy" className="mb-10">
                  ...
                  <p className="text-gray-700 text-base leading-relaxed mb-4">
                    You agree not to use our Service to generate, upload, or
                    share content that:
                  </p>
                  <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 text-base leading-relaxed">
                    ...
                    <li>
                      Contains hate speech, harassment, or discriminatory
                      content
                    </li>
                    <li>Violates any applicable laws or regulations</li>
                    <li>Spreads misinformation or harmful content</li>
                    <li>
                      Attempts to impersonate real individuals without consent
                    </li>
                  </ul>
                  ...
                  <p className="text-gray-700 text-base leading-relaxed">
                    We reserve the right to remove content and suspend or
                    terminate accounts that violate these policies without prior
                    notice.
                  </p>
                </section>
                ...
                <section id="7-intellectual-property-rights" className="mb-10">
                  ...
                  <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 text-base leading-relaxed">
                    <li>
                      We own all rights to the Service, including AI models,
                      software, and technology
                    </li>
                    <li>
                      Our trademarks, logos, and brand elements are our
                      exclusive property
                    </li>
                    <li>
                      These Terms do not grant you any rights to our
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 text-base leading-relaxed">
                    ...
                    <li>
                      You may not attempt to extract, reverse engineer, or
                ...
                <section id="8-user-generated-content" className="mb-10">
                  ...
                  <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 text-base leading-relaxed">
                    <li>
                      You retain ownership rights to content you generate using
                      our Service
                    </li>
                    <li>
                      We do not claim ownership of your generated images or
                      videos
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 text-base leading-relaxed">
                    ...
                    <li>
                      The right to use public content for promotional and
                      marketing purposes
                    </li>
                    <li>
                      The right to use aggregated, anonymized data to improve
                      our Service
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 text-base leading-relaxed">
                    <li>
                      All content generated on the free plan is publicly visible
                      by default
                    </li>
                    <li>
                      Other users may view, share, and use your public content
                    </li>
                    <li>
                      You can generate private content with paid subscription
                      plans
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 text-base leading-relaxed">
                    <li>
                      You are free to use generated content for commercial
                      purposes
                    </li>
                    <li>
                      This includes selling, licensing, or monetizing your
                      generated content
                    </li>
                    <li>
                      You are responsible for ensuring commercial use complies
                ...
                <section id="9-service-availability" className="mb-10">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 text-base leading-relaxed">
                    ...
                    <li>
                      No compensation is provided for service modifications or
                      interruptions
                    </li>
                  </ul>
                </section>
                ...
                <section id="10-disclaimers" className="mb-10">
                  ...
                  <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 text-base leading-relaxed">
                    ...
                    <li>
                      You are responsible for reviewing and verifying generated
                      content before use
                    </li>
                    <li>
                      We make no warranties about the quality or suitability of
                      generated content
                    </li>
                  </ul>
                ...
                <section id="11-limitation-of-liability" className="mb-10">
                  ...
                  <div className="bg-gray-50 border-l-4 border-gray-400 p-5 rounded-r-lg mb-5">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-gray-700 text-base leading-relaxed">
                      ...
                      <li>
                        Damages exceeding the amount paid by you in the 12
                ...
                <section id="12-termination" className="mb-10">
                  ...
                  <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 text-base leading-relaxed">
                    ...
                    <li>
                      Termination does not entitle you to a refund except as
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 text-base leading-relaxed">
                    ...
                    <li>
                      Public content may remain visible unless specifically
                      removed
                    </li>
                    <li>
                ...
                <section id="13-refund-policy" className="mb-10">
                  ...
                  <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 text-base leading-relaxed">
                    ...
                    <li>
                      Refunds are calculated based on unused credits/services on
                      a pro-rata basis
                    </li>
                    <li>
                      No refunds for services already consumed or credits used
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 text-base leading-relaxed">
                    <li>
                      Request refunds by contacting {siteConfig.contact.email}
                    </li>
                ...
                <section id="15-modifications-to-terms" className="mb-10">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 text-base leading-relaxed">
                    <li>
                      Updated Terms will be posted with a new &quot;Last
                      updated&quot; date
                    </li>
                ...
                <section id="16-dispute-resolution" className="mb-10">
                  ...
                  <p className="text-gray-700 text-base leading-relaxed mb-4">
                    ...
                    to contact us at {siteConfig.contact.email} to seek an
                    informal resolution.
                  </p>
                  ...
                  <p className="text-gray-700 text-base leading-relaxed mb-4">
                    If informal resolution fails, any disputes will be resolved
                    through binding arbitration rather than in court, except
                ...
                <section id="17-general-provisions" className="mb-10">
                  ...
                  <p className="text-gray-700 text-base leading-relaxed">
                    ...
                    where our service operates, without regard to conflict of
                    law principles.
                  </p>
                </section>
                ...
                <div className="text-center">
                  <p className="text-gray-600 text-sm italic">
                    ...
                    date and will remain in effect until modified or terminated
